...
fn test_generate_check_codes(){
    ...
    assert_eq!(check_codes[2..], [12, 2, 3, 1, 9]);
}
...
fn test_generate_check_codes2(){
    ...
    assert_eq!(check_codes[2..], [0b1010, 0b0011, 0b1011, 0b1000, 0b0100]);
}
...
fn test_generate_check_codes3(){
    ...
    assert_eq!(check_codes[2..], [0b1110, 0b0111, 0b0101, 0b0000, 0b1011]);
}
...
fn test_generate_check_codes4(){
    ...
    assert_eq!(check_codes[2..], [0b0111, 0b1000, 0b0111, 0b1001, 0b0011]);
}
...
fn test_generate_check_big(){
    ...
    assert_eq!(check_codes[10..], [44, 29, 43, 52, 49, 22, 15]);
}
